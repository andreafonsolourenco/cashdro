<%@ Page Language="C#" AutoEventWireup="true" CodeFile="menu_maquina.aspx.cs" Inherits="menu_maquina" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="row buttonsRowPadding">
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 buttonsPadding">
                                <div class="card card-stats mb-4 mb-xl-0 bg-gradient-primary pointer" onclick="openOperationsMenu();">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Menu Operações</h5>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 buttonsPadding">
                                <div class="card card-stats mb-4 mb-xl-0 bg-gradient-primary pointer" onclick="openConsultationMenu();">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Menu Consulta</h5>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 buttonsPadding">
                                <div class="card card-stats mb-4 mb-xl-0 bg-gradient-primary pointer" onclick="propriedades();">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Propriedades</h5>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 buttonsPadding variaveis" id="editButton">
                                <div class="card card-stats mb-4 mb-xl-0 bg-gradient-primary pointer" onclick="edita();">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Editar</h5>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 buttonsPadding variaveis" id="deleteButton">
                                <div class="card card-stats mb-4 mb-xl-0 bg-gradient-primary pointer" onclick="apaga();">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0 text-white">Eliminar</h5>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
    ...
    <script>
        ...
        function podeCriarEditar() {
            var id = localStorage.loga;
            $.ajax({
                type: "POST",
                url: "menu_maquina.aspx/podeCriarEditar",
                data: '{"id":"' + id + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
        ...
        function propriedades() {
            var id = $('#txtAux').val();
            loadUrl("propriedades_maquina.aspx?id=" + id);
        }

        function openOperationsMenu() {
            var id = $('#txtAux').val();
            loadUrl("menu_operacoes.aspx?id=" + id);
        }

        function openConsultationMenu() {
            var id = $('#txtAux').val();
            loadUrl("menu_consulta.aspx?id=" + id);
        }
