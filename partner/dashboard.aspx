        ...
        <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
            <div class="container-fluid">
                <div class="header-body">
                    <!-- Card stats -->
                    <div class="row">
                        <div class="variaveis" id="header1">
                        ...
                        <div class="variaveis" id="header2">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                        ...
                        <div class="variaveis" id="header3">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                        ...
                        <div class="variaveis" id="header4">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
        ...
        function getPermissions() {
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (administrador) {
                        $('#header1').addClass('col-xl-3 col-lg-6');
                        $('#header2').addClass('col-xl-3 col-lg-6');
                        $('#header3').addClass('col-xl-3 col-lg-6');
                        $('#header4').addClass('col-xl-3 col-lg-6');
                    }
                    else {
                        getTotals();
