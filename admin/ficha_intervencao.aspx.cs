...
public partial class ficha_intervencao : System.Web.UI.Page
{
    string id = "";
    string id_maquina = "";
    string page = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request != null && Request.QueryString["page"] != null)
        {
    ...
    public static string saveData(string id, string id_maquina, string data_hora, string tecnico, string pecas, string notas)
    {
        ...
        sql = string.Format(@"  DECLARE @id int={0}
                                ...
                                EXECUTE cashdro_intervencao_novoedita @id,@id_maquina, @data_hora, @tecnico, @pecas, @notas,@ret OUTPUT,@retMsg OUTPUT
                                ...
                                inner join CASHDRO_REPORT_INTERVENCOES(@ret, @id_maquina) interv on interv.id_maquina = maq.id",
        ...
        if (oDB.validaDataSet(oDs))
        {
            ...
            intro = "INTERVENÇÃO - " + cliente + " - " + localizacao + "(" + serial + ")";
            body = "Serve o presente e-mail para informar V.Exª que foi efectuada uma intervenção na sua máquina com os seguintes dados:<br /><br />";
    ...
    public static string getData(string id)
    {
        ...
        sql = string.Format(@"  declare @id_intervencao int = {0};
                                ...
                                SELECT
                                    ...
                                    pecas_intervencao,
                                    notas_intervencao
                                FROM CASHDRO_REPORT_INTERVENCOES(@id_intervencao, @id_maquina) ", id);
