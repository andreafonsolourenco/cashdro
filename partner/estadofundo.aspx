<%@ Page Language="C#" AutoEventWireup="true" CodeFile="estadofundo.aspx.cs" Inherits="estadofundo" %>
...
<body onload="getData();">
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Estado de fundo</a>
                <!-- Form -->
                ...
                <div class="row align-items-center justify-content-xl-between">
                    <div class="col-xl-6">
                        <div class="copyright text-center text-xl-left text-muted">
                            <input type="text" id="txtID" runat="server" class="variaveis" />
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <script>
        ...
        function getData() {
            ...
            $.ajax({
                type: "POST",
                url: "estadofundo.aspx/getGrelha",
                data: '{"id":"' + id + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
