...
public partial class lista_maquinas : System.Web.UI.Page
{
    ...
    public static string getTotais(string id_utilizador)
    {
        ...
        sql = @" select
		            ...
		            total4,
		            rodape4
	            from [cashdro_estadomaquinas_totaispagina_tecparceiro] (" + id_utilizador + ") tmp ";
    ...
    public static string podeCriarMaquinas(string id)
    {
        ...
        sql = string.Format(@"  DECLARE @id int = {0};
                                select nr_maq_disponiveis from CASHDRO_REPORT_NUM_MAQUINAS_PARCEIRO(@id)", id);
    ...
    public static string getGrelha(string pesquisa, string order, string userid)
    {
        ...
        string tp = podeCriarEditar(userid);
    ...
    public static string atualizaDados(string userid)
    {
        ...
        sql = String.Format(@"  declare @id_maquina int;
                                    ...
                                    SELECT
                                        ...
                                        [password],
                                        username
                                    FROM CASHDRO_REPORT_MAQUINAS_TECPARCEIRO(@id_parceiro)
                                    WHERE ATIVO = @ativo", userid);
