<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lista_intervencoes.aspx.cs" Inherits="lista_intervencoes" %>
...
<head>
    ...
    <meta name="description" content="CASHDRO Software - Lista de Intervenções">
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Intervenções</a>
                <!-- Form -->
    ...
    <script>
        ...
        function loga() {
            ...
            // Se temos sessao, temos que ver se a mesma ainda é válida
                ...
                $.ajax({
                    type: "POST",
                    url: "lista_intervencoes.aspx/trataExpiracao",
                    data: '{"i":"' + id + '"}',
        ...
        function getUserName() {
            ...
            $.ajax({
                type: "POST",
                url: "lista_intervencoes.aspx/getUname",
                data: '{"i":"' + id + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
        ...
        function novo() {
            var id = $('#ddlMaquina').val();
            var page = $('#txtPage').val();

            if (id != '0') {
                if (page != null) {
                    window.location = "ficha_intervencao.aspx?id_maquina=" + id + "&page=" + page;
                    return;
                }

                window.location = "ficha_intervencao.aspx?id_maquina=" + id;
                return;
            }

            if (page != '') {
                window.location = "ficha_intervencao.aspx?page=" + page;
                return;
            }

            window.location = "ficha_intervencao.aspx";
        }


        function edita(id) {
            var idMaq = $('#ddlMaquina').val();
            var page = $('#txtPage').val();
            var param = "?id=" + id;

            if (idMaq != '0') {
                param += '&id_maquina=' + idMaq;
            }
            ...
            window.location = "ficha_intervencao.aspx" + param;
        }
        ...
        function getData() {
            ...
            $.ajax({
                type: "POST",
                url: "lista_intervencoes.aspx/getGrelha",
                data: '{"pesquisa":"' + pesquisa + '","order":"' + order + '","idMaq":"' + $('#txtAux').val() + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
        ...
        function apaga(id) {
            swal({
                ...
                text: "A intervenção será eliminada. Confirma?",
                type: 'question',
                ...
                $.ajax({
                    type: "POST",
                    url: "lista_intervencoes.aspx/delRow",
                    data: '{"id":"' + id + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        ...
                        if (res == -1) {
                            sweetAlertWarning("Eliminar Intervenção", resMsg);
                        }
                        else
                            loadUrl("lista_intervencoes.aspx");
                    }
                });
            });
        }
