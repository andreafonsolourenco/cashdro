...
<body onload="getData();">
                        ...
                        <div class="card-header border-0">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 10%; text-align: right; cursor: pointer; display:none; margin-left:25px" onclick="novo();" id="tdNovo">
                                        <img src="../general/assets/img/theme/new.png" style="width: 30px; height: 30px" alt="Criar nova categoria" title="Criar nova máquina" />
                                    </td>
    ...
    <script>
        ...
        function podeCriarEditar() {
            ...
            $.ajax({
                type: "POST",
                url: "lista_maquinas.aspx/podeCriarEditar",
                data: '{"id":"' + id + '"}',
                ...
                success: function (res) {
                    var ret = res.d;
                    if (ret == "Parceiro") {
                        document.getElementById('tdNovo').style.display = 'block';
