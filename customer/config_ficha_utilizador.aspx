...
<body>
                    ...
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body" id="divGrelha">
                            <form>
                                ...
                                <hr style="display:none" class="my-4" />
                                <!-- Description -->
                                <h6 style="display:none" class="heading-small text-muted mb-4">Estado</h6>

                                <div style="display:none" class="row" style="padding-left: 0px">
                                    <div class="col-md-6">
    ...
    <script>
        ...
        function saveData() {
            ...
            var nclientesparceiro = $('#txtNClientesParceiro').val();
            ...
            else if (nclientesparceiro == '' || nclientesparceiro == null || nclientesparceiro == undefined) {
                nclientesparceiro = '0';
            }
