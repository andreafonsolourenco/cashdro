...
public partial class lista_manutencoes : System.Web.UI.Page
{
    ...
    public static string getDadosMaquina(string idUser, string idMaq)
    {
        ...
        string img = @" <td style='width: 10%; text-align: right; cursor: pointer;'>
                            <img src='../general/assets/img/theme/new.png' style='width: 30px; height: 30px' alt='Criar nova manutenção' title='Criar nova manutenção' onclick='novo();'/>
                        </td>";
        ...
        if (oDB.validaDataSet(oDs))
        {
            for (int i = 0; i < oDs.Tables[0].Rows.Count; i++)
            {
                ...
                ret = String.Format(@"  <table style='width: 100%'>
                                            <tr>
                                                <td style='width:{0}'>
                                                    <h3 class='mb-0'>Manutenções Programadas</h3>
                                                </td>
                                                {1}
                                            </tr>
                                            <tr>
