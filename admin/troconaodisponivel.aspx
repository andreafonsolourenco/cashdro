<%@ Page Language="C#" AutoEventWireup="true" CodeFile="troconaodisponivel.aspx.cs" Inherits="troconaodisponivel" %>
...
<body onload="getData();">
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Troco não disponível</a>
                <!-- Form -->
                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <table style="width: 100%">
                                <tr>
                                    <td style="width: 90%">
                                        <h3 class="mb-0">Troco não disponível</h3>
                                    </td>
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col">NIF</th>
                                            <th scope="col" style="text-align: left;">Ativo</th>
                                            <th scope="col"></th>
                                        </tr>
                                    </thead>
    ...
    <script>
        ...
        function back() {
            var url = "menu_operacoes.aspx?id=" + $('#txtID').val();
            loadUrl(url);
        }
        ...
        function getData() {
            ...
            $.ajax({
                type: "POST",
                url: "troconaodisponivel.aspx/getGrelha",
                data: '{"id":"' + id + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
