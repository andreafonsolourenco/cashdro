<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ficha_intervencao.aspx.cs" Inherits="ficha_intervencao" %>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <span class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Intervenção</span>
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-12 col-md-10">
                        <h1 class="display-2 text-white">Intervenções</h1>
                        <p class="text-white mt-0 mb-5">Crie/edite os dados de intervenção</p>
        ...
        <div class="container-fluid mt--7">
                ...
                <div class="col-xl-8 order-xl-1">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body" id="divGrelha">
                            <form>
                                <h6 class="heading-small text-muted mb-4">Informação da Intervenção</h6>
                                <div class="row">
                                    <div class="col-md-6" id="divMaquinas" runat="server"></div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="txtDataHora">Data / Hora</label>
                                            <input type="datetime-local" id="txtDataHora" class="form-control form-control-alternative" value="2020-01-01T00:00">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
            ...
            <div id="hiddenVals" class="variaveis">
                ...
                <input id="txtAuxPage" runat="server" type="text" class="variaveis" />
            </div>
    ...
    <script>
        ...
        function back() {
            ...
            alertify.confirm("Tem a certeza que pretende sair?!<br />Todas os dados serão perdidos.",
                ...
                }).set('labels', { ok: 'Sim', cancel: 'Não' }).set('title', 'Intervenções');
        }
        ...
        function getData() {
            ...
            if (id != null && id != 'null' && id != '') {
                $.ajax({
                    type: "POST",
                    url: "ficha_intervencao.aspx/getData",
                    data: '{"id":"' + id + '"}',
        ...
        function saveData() {
            ...
            if (data != '' && data != null && data != undefined &&
                ...
                $.ajax({
                    type: "POST",
                    url: "ficha_intervencao.aspx/saveData",
                    ...
                    success: function (res) {
                        ...
                        if (dados[0] > 0) {
                            loadUrl('lista_intervencoes.aspx?id=' + idMaq);
                            return;
                        }
                        else {
