...
<body>
                        ...
                        <div class="card-header border-0">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 10%; text-align: right; cursor: pointer" runat="server" id="imgDiv"></td>
                                </tr>
                                <tr>
                                    <td style="width: 90%">
    ...
    <script>
        ...
        function novo() {
            var url = "ficha_intervencao.aspx?id_maquina=" + $('#txtAux').val();
            loadUrl(url);
        }


        function edita(id) {
            var url = "ficha_intervencao.aspx?id=" + id + '&id_maquina=' + $('#txtAux').val();
            loadUrl(url);
        }
